...
public class Lightcaster : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Array.Sort(angleds, delegate(angledVerts one, angledVerts two) { return one.angle.CompareTo(two.angle); }); //sort the struct array of vertices from smallest angle to greatest.
